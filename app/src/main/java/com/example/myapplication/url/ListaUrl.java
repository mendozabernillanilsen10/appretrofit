...
public class ListaUrl  {
    ...
    public ListaUrl() {
        ...
        //listaUrl.add(new URL("http://34.194.71.145/dashboardQA/agv/gmotareo/get/GetQuerygg.php?iddatabase=AGVTEAM_TEST&query=exec MobileGetListParamMateriaPrima 'AGROVISIONCORP', '001',1;", 3));
        listaUrl.add(new URL("http://34.194.71.145/dashboardQA/agv/gmotareo/get/GetQuery.php?iddatabase=AGVTEAM_TEST&query=exec GetListCosechaLabor 'AGROVISIONCORP', '001';", 4, null, "tabla_api4_01"));
        listaUrl.add(new URL("http://52.3.85.45/dashboard/agv/gmotareo/get/ListTrabajadores2021.php?iddatabase=AGROVISIONTEAM&iddatabase2=AGROVISIONCORP&idempresa=001", 4, null, "tabla_api4_02"));
